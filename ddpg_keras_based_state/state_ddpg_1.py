...
class Actor(Model):
    def __init__(self, action_dim):
        ...
        self.dense1 = Dense(64, activation='relu', kernel_initializer='zeros')
        self.dense2 = Dense(32, activation='relu', kernel_initializer='zeros')
        self.dense3 = Dense(16, activation='relu', kernel_initializer='zeros')
        self.action = Dense(self.action_size, activation='tanh', kernel_initializer='zeros')
...
class Critic(Model):
    def __init__(self):
        ...
        self.x1 = Dense(32, activation='relu', kernel_initializer='zeros')
        self.a1 = Dense(32, activation='relu', kernel_initializer='zeros')
        self.h2 = Dense(32, activation='relu', kernel_initializer='zeros')
        self.h3 = Dense(16, activation='relu', kernel_initializer='zeros')
        self.q = Dense(1, activation='linear', kernel_initializer='zeros')
