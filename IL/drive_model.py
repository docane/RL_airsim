...
MODEL_PATH = 'models_2023_02_13_13_53_30/fresh_models/model_model.15-0.0202197.h5'
...
while True:
    ...
    # Print progress
    print('Sending steering = {0}, throttle = {1}, prediction time = {2}'.format(received_output, car_controls.throttle,
